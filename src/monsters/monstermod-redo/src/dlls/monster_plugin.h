...
typedef struct
{
   ...
   int respawn_monster_type;
   Vector respawn_origin;
   Vector respawn_angles;
   int respawn_spawnflags;
} monster_t;
...
typedef struct
{
   ...
   int spawnflags;
   float respawn_time;
} monster_dynamic_respawn_t;

#define MAX_DYNAMIC_RESPAWNS 200
extern monster_dynamic_respawn_t monster_dynamic_respawn_queue[MAX_DYNAMIC_RESPAWNS];
