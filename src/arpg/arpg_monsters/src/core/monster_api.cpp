...
plugin_info_t Plugin_info = {
   ...
   "ARPG Hutao Monsters",							// name
   "0.1.0",										// version
   "20/05/2026",									// date in DD/MM/YYYY format
   "botman, Rick90, Giegue, Ako",					// original authors + ARPG fork
   "local-arpg-hutao-fork",							// url
   "ARPGMON",										// logtag
...
cvar_t init_monster_dynamic_respawn = {"monster_dynamic_respawn", "1", FCVAR_EXTDLL, 0, NULL};
cvar_t *monster_dynamic_respawn = NULL;
cvar_t init_monster_dynamic_respawn_delay = {"monster_dynamic_respawn_delay", "10", FCVAR_EXTDLL, 0, NULL};
cvar_t *monster_dynamic_respawn_delay = NULL;
...
C_DLLEXPORT int Meta_Attach(PLUG_LOADTIME now, META_FUNCTIONS *pFunctionTable, meta_globals_t *pMGlobals, gamedll_funcs_t *pGamedllFuncs)
{
	...
	CVAR_REGISTER(&init_monster_dynamic_respawn);
	monster_dynamic_respawn = CVAR_GET_POINTER("monster_dynamic_respawn");

	CVAR_REGISTER(&init_monster_dynamic_respawn_delay);
	monster_dynamic_respawn_delay = CVAR_GET_POINTER("monster_dynamic_respawn_delay");
